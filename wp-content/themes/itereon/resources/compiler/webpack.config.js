...
module.exports = ( options ) => {
	...
	return {
		...
		// 	'styles/bs': dev ? [hmr, entry.bs] : entry.bs,
		// 	'styles/fa': dev ? [hmr, entry.fa] : entry.fa,
			...
			rules: [
				...
				},
				{
					...
					use: [
						...
						{loader: 'sass-loader', options: {sourceMap: true, sourceMapContents: dev, importer: globImporter()}},
					]
				},
				{
		...
		plugins: [
			...( dev ? [
				...
				new StylelintPlugin({
					context: path.resolve( context ) + '/styles/',
					fix: true
				})
			] : [
